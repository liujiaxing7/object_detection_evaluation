...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.menuBar=QtWidgets.QMainWindow.menuBar(Dialog)
        self.file=self.menuBar.addMenu("菜单")
        self.show_action = self.file.addAction("show database")
        self.show_action.triggered.connect( Dialog.btn_db)
        self.visual_action = self.file.addAction("visual comparsion")
        self.visual_action.triggered.connect(Dialog.btn_visual)


        #button
        self.combobox_process = QtWidgets.QComboBox(Dialog)
        self.combobox_process.setGeometry(QtCore.QRect(151, 295, 221, 27))
        ...
        self.btn_gt_images_dir.setGeometry(QtCore.QRect(1170, 100, 31, 27))
        self.btn_gt_images_dir.setObjectName("btn_gt_images_dir")
        self.txb_gt_images_dir = QtWidgets.QLineEdit(Dialog)
        self.txb_gt_images_dir.setGeometry(QtCore.QRect(110, 100, 1051, 27))
        ...
        self.lbl_groundtruth_dir_3.setGeometry(QtCore.QRect(10, 40, 1191, 20))
        font = QtGui.QFont()
        ...
        self.lbl_groundtruth_dir_24.setGeometry(QtCore.QRect(10, 400, 101, 17))
        self.lbl_groundtruth_dir_24.setObjectName("lbl_groundtruth_dir_24")

        self.txb_classes_gt = QtWidgets.QLineEdit(Dialog)
        self.txb_classes_gt.setGeometry(QtCore.QRect(110, 130, 1051, 27))
        ...
        self.lbl_groundtruth_dir_25.setGeometry(QtCore.QRect(10, 135, 101, 17))
        self.lbl_groundtruth_dir_25.setObjectName("lbl_groundtruth_dir_25")
        self.btn_groundtruth_dir_5 = QtWidgets.QPushButton(Dialog)
        self.btn_groundtruth_dir_5.setGeometry(QtCore.QRect(1170, 130, 31, 27))
        ...
        self.btn_groundtruth_dir_6.setGeometry(QtCore.QRect(10, 295, 141, 27))
        self.btn_groundtruth_dir_6.setObjectName("btn_groundtruth_dir_6")
        self.lbl_groundtruth_dir_27 = QtWidgets.QLabel(Dialog)
        self.lbl_groundtruth_dir_27.setGeometry(QtCore.QRect(110, 160, 531, 21))
        ...
        self.process.setGeometry(QtCore.QRect(37, 350, 1110, 200))
        self.process.ensureCursorVisible()


        self.btn_save_db = QtWidgets.QPushButton(Dialog)
        self.btn_save_db.setGeometry(QtCore.QRect(1090, 295, 50, 27))
